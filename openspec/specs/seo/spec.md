...
Every page SHALL have a unique, descriptive `<title>` element and a `<meta name="description">` tag. The title SHALL follow the pattern: `<Page Title> | Capoeira Oldenburg e. V.` (or similar consistent format).
